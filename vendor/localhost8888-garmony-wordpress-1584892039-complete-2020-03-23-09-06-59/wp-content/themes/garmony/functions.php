...
function menu() {
  ...
  add_theme_support( 'post-thumbnails', array('post', 'catalog', 'slider') );
...
function script_them() {
  wp_enqueue_script('magnific', get_template_directory_uri() . '/buildjs/jquery.magnific-popup.min.js');
  wp_enqueue_script('owl', get_template_directory_uri() . '/buildjs/owl.carousel.min.js');
...
function register_post_types(){
  register_post_type('catalog', array(
    ...
    'labels' => array(
      ...
      'singular_name'      => 'фото для галереи', // название для одной записи этого типа
      'add_new'            => 'Добавить фото в галерею', // для добавления новой записи
      'add_new_item'       => 'Добавление нового фото в галерею', // заголовка у вновь создаваемой записи в админ-панели.
      'edit_item'          => 'Редактирование галереи', // для редактирования типа записи
      'new_item'           => 'Новое фото для галереи', // текст новой записи
      'view_item'          => 'Смотреть галерею', // для просмотра записи этого типа.
      'search_items'       => 'Искать фото в галереи', // для поиска по этим типам записи
      'not_found'          => 'Не найдиное фото в галереи', // если в результате поиска ничего не было найдено
      'not_found_in_trash' => 'Не найдиное фото галереи в корзине', // если не было найдено в корзине
